    ...
    <body>
        <header>
            <div class="container">
                ...
                <nav>
                    <ul>
                        <li><a>Produtos Neon</a></li>
                        <li><a>Conta digital PJ</a></li>
                        <li><a>Conta digital PJ</a></li>
                        <li><a>Blog</a></li>
                        <li><a>Ajuda</a></li>
                    </ul>
        ...
        <footer>
            <div class="container">
                ...
                <div class="msg">
                    <div class="icon">😀</div>
                    <p>
                        Oi! Leu até aqui? Você se preocupa com os mínimos
                        detalhes, mesmo. A gente também. Por isso o time Neon
                        está sempre trabalhando para fazer a conta digital
                        perfeita para você ; )
                    </p>
                </div>
            </div>
        ...
        <script>
            var swiper = new Swiper(".slide-depoimentos", {
                ...
                spaceBetween: 32,
                pagination: {
                    el: ".depoimentos .top .swiper-pagination",
                    clickable: true,
                },
                breakpoints: {
                    320: {
